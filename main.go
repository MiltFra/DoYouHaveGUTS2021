...
func (pos Coord) Up() Coord {
	return Coord{X: pos.X, Y: pos.Y + 1}
}

func (pos Coord) Down() Coord {
	return Coord{X: pos.X, Y: pos.Y - 1}
}

func (pos Coord) Left() Coord {
	return Coord{X: pos.X - 1, Y: pos.Y}
}

func (pos Coord) Right() Coord {
	return Coord{X: pos.X + 1, Y: pos.Y}
}
...
func HandleIndex(w http.ResponseWriter, r *http.Request) {
	response := BattlesnakeInfoResponse{
		APIVersion: "1",
		Author:     "Franz Miltz & Eric Janto", // TODO: Your Battlesnake username
		Color:      "#ff4c00",                  // TODO: Personalize
...
func HandleMove(w http.ResponseWriter, r *http.Request) {
	...
	move := string(ChooseAStarMove(&request.Board, &request.You))
